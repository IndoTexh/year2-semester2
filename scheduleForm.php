...
<body>
    ...
    <div class="main-content">
        ...
        <form action="insertSchedule.php" method="POST" enctype="multipart/form-data">
            <div class="row">
                <div class="col-lg-6">
                    <select name="subjectID" class="form-select form-control mb-2 mt-4">
                    ...
                    <select name="days" class="form-select form-control mb-2">
                        <option>Select day for that subject</option>
                        <?php
                        include("conn.php");
                        ...
                        if (mysqli_num_rows($select) > 0) {
                            while ($row = mysqli_fetch_assoc($select)) {
                        ?>
                                <option value="<?php echo $row["DayID"] ?>"><?php echo $row["DayID"] ?> <?php echo $row["DayName"] ?></option>
                        <?php
                            }
                        }
                        ?>
                    ...
                    <select name="timeID" class="form-select form-control mb-2">
                        <option>Time ID</option>
                        <?php
                        include("conn.php");
