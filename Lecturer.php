...
<body>
    ...
    <div class="main-content">
        ...
        <form action="InsertLecturer.php" method="POST" enctype="multipart/form-data">
            <div class="row">
                <div class="col-lg-6">

                    <input class="form-control form-control mb-2 mt-4" type="text" placeholder="Lecturer' Name" name="lecturerName" autocomplete="off">

                </div>
                <div class="col-lg-6">
                    <input type="file" class="form-control form-control mb-2 mt-4" name="Image">
                </div>
            </div>
