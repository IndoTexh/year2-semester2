...
<body>
    ...
    <div class="main-content">
        ...
        ?>
        <a href="batchForm.php" class="btn btn added" style="background: rgb(113, 99, 186); color:#fff">Add Batch</a>
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td><?php echo $row["BatchKH"] ?></td>
                                    <td>
                                        <?php echo $row["BatchEN"] ?>
                                    </td>
                                    <td>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li>
                                                    <a class="dropdown-item" href="insertBatch.php?updateID=<?php echo $row["BatchID"] ?>">
                                                        <i class="fas fa-edit"></i> Edit

                                                    </a>
                                                </li>
                                                <li><a onclick="javascript:return confirm('Are you sure want to delete this record?');" class="dropdown-item" href="insertBatch.php?deleteID=<?php echo $row["BatchID"] ?>"><i class="fas fa-trash"></i> Delete</a></li>
                                            </ul>
                                        </div>
                                    </td>
                                </tr>
