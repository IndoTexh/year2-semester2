...
<body>
    ...
    <div class="main-content">
        ...
        ?>
        <a href="campusForm.php" class="btn btn added" style="background: rgb(113, 99, 186); color:#fff">Add Campus</a>
                                    ...
                                    <td>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li>
                                                    <a class="dropdown-item" href="campusInsert.php?updateID=<?php echo $row["CampusID"] ?>">
                                                        <i class="fas fa-edit"></i> Edit

                                                    </a>
                                                </li>
                                                <li><a onclick="javascript:return confirm('Are you sure want to delete this record?');" class="dropdown-item" href="campusInsert.php?deleteID=<?php echo $row["CampusID"] ?>"><i class="fas fa-trash"></i> Delete</a></li>
                                            </ul>
                                        </div>
                                    </td>
                                </tr>
