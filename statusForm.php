...
<body>
    ...
    <div class="main-content">
        ...
        <form action="statusInsert.php" method="POST" enctype="multipart/form-data">
            <div class="row">
                <div class="col-lg-6">
                    <select name="studentID" class="form-select form-control mb-2 mt-4">
                        <option>Select Student ID</option>

                        <?php
                        include("conn.php");
                        $select = mysqli_query($conn, "SELECT * FROM tblstudent");
                        if (mysqli_num_rows($select) > 0) {
                            while ($row = mysqli_fetch_assoc($select)) {
                        ?>
                                <option value="<?php echo $row["StudentID"] ?>"><?php echo $row["StudentID"] ?> <?php echo $row["NameInLatin"] ?></option>
                        <?php
                            }
                        }
                        ?>
                    ...
                    <select name="programID" class="form-control form-control mb-2 mt-4">
                    ...
                    <select name="assigned" class="form-select form-control mb-2 mt-4">
                ...
                <div class=" col-lg-6">
                    <input type="text" class="form-control form-control mb-2 mt-4" name="note" placeholder="Note">

                    <label class="mt-4 mb-2">Assigned Date</label>
