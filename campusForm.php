...
<body>
    ...
    <div class="main-content">
        ...
        <form action="campusInsert.php" method="POST">
            <div class="row">
                <div class="col-lg-6">

                    <input class="form-control form-control mb-2 mt-4" type="text" placeholder="សាខា" name="campusKH" autocomplete="off">
                </div>
                <div class="col-lg-6">
                    <input class="form-control form-control mb-2 mt-4" type="text" placeholder="Campus" name="campusEN" autocomplete="off">
                </div>
            </div>
