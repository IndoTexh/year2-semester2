...
<body>
    ...
    <div class="main-content">
        ...
        ?>
        <a href="ShiftForm.php" class="btn btn added" style="background: rgb(113, 99, 186); color:#fff">Add Shift</a>
                                    ...
                                    <td>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li>
                                                    <a class="dropdown-item" href="ShiftInsert.php?updateID=<?php echo $row["ShiftID"] ?>">
                                                        <i class="fas fa-edit"></i> Edit

                                                    </a>
                                                </li>
                                                <li><a onclick="javascript:return confirm('Are you sure want to delete this record?');" class="dropdown-item" href="ShiftInsert.php?deleteID=<?php echo $row["ShiftID"] ?>"><i class="fas fa-trash"></i> Delete</a></li>
                                            </ul>
                                        </div>
                                    </td>
                                </tr>
